      ...
      <Box className="container">
        <Paper elevation={4} sx={{ mb: 2, padding: 1 }}>
          ...
          <Typography variant="body2">
            Bats: {user.bats.toUpperCase()} | Throws:{" "}
            {user.throws.toUpperCase()}
          </Typography>
        </Paper>
        ...
        >
          ...
          {joinTeamToggle && (
            <JoinTeamForm
              errors={errors}
              joinTeamToggle={joinTeamToggle}
              setToggle={setToggle}
              toggle={toggle}
              setJoinTeamToggle={setJoinTeamToggle}
            />
          )}
          ...
          >
            ...
            <List sx={{ maxHeight: 250, overflowY: "scroll" }}>
              {!playerGames.playerTeamReducer.length > 0 &&
                `Uh-oh no teams found! Join one to see it here! Simply click 'Join a Team' button above to get started.`}
              {playerGames.playerTeamReducer.length > 0 &&
